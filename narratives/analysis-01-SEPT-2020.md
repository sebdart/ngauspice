---
title: Phylodynamics of SARS-CoV-2.
authors:
...
dataset: "https://localhost:8080/sars-cov-2/subsample?animate=2019-11-20,2020-04-15,1,1,15000&d=tree,map&p=grid&r=region"
abstract: "
(U) This report uses publicly shared raw genomic data to track the spread of SARS-CoV-2 mutations around the world. All the raw genomic data presented herewith (under SARS-CoV-2 dataset) have been filtered, bioinformatically processed, and modeled by NGA Data Corps; for any questions and/or requests, please, contact us.
\n\n(U) Although fully Unclassified, this report is only meant for Government Officials.
\n\n(U) We are deeply indebted to <a href='https://www.hpc.mil' target='_blank'>DOD HPC</a> team for providing access to their supercomputer facilities and their continuous help and support; without them, this computational bio-informatic project would not have been possible.
\n\n(U) We are also gratefull to NGA DCD tech and AWS teams for their help and support to enhance this visualization analytics."
---

<!-- ######################################################################################################  -->
<!-- #################################### TABLE of CONTENT HERE  n=1 ######################################  -->
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 1-->
# [Table of Contents](https://localhost:8080/sars-cov-2/subsample)

* [Background Resources and Further Readings](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=2).
* [About Sampling](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=3).
* [SARS-CoV-2 Mutations](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=4).
 * [A Mutation Worth Tracking?](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=5).
* [SARS-CoV-2 in North America](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=9).
 * [The First Carrier in the USA?](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=12).
 * [Situation Before March 2020](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=13).
 * [When did SARS-CoV-2 Arrive in New-York?](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=15).
* [SARS-CoV-2 in Europe](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=17).
 * [Situation Before 27 March 2020](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=19).
 * [The First Carrier in Europe?](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=21).
* [Conclusions](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=22).
* [Scientific Credits](https://sars-cov-2.dev.east.paas.nga.mil/narratives/analysis-01-SEPT-2020?n=23).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# (U) Executive summary

(U) We present, for the first time, 31,695 SARS-CoV-2 genomes collected from December 2019 to August 2020; this was an enormous computational challenge to undertake. Thanks to this new modeled genomic database, we are now able to present unique results about this pandemic.

(U) By comparing viral genomes to each others, one can characterize how SARS-CoV-2 is moving around the world and spreading within our communities. Last but not least, one can track how the virus mutates as it is spreading; this is key to monitor newly mutated viral forms and, as importantly, to keep track of the exact orgin of a given observed mutation (ie., surveilling and tracing back a virus in a given community at a given time).

(U) This is the only SARS-CoV-2 analytical placeholder where one can find and download the complete dataset of tens of thousands of SARS-CoV-2 genomic sequences. Although, similar results may be found elsewhere, our modeling approach used all available data for a comprehensive analysis; the disadvantage is that the data take a long time to load through internet connection. If you want to analyze the dataset yourself on your local computer, just [contact us](mailto:sebastien.dartevelle.nga.mil).

(U) Herewith, we report:

## Is it Mutating? How? Where?
* SARS-CoV-2 is mutating as it spreads around the world.
* The mutation rate is about 14.8 to 20 mutations per year (about 1.2 to 1.6 mutations per month).
* This a slow mutation rate, which is similar around the world.
* A specific mutation, D614G, which may be caused of concerns in terms of transmissibility, is common in the USA and in Europe. Our model indicates it emerged around mid-December 2019, likely from China. Once it took hold in Europe, it easily spread to the rest of the world.

## North America
* Extensive genetic mixing across the U.S.
* Since mid-March 2020, the virus spreads entirely within local communities (i.e., domestically).
* Patient ZERO in New-York City caught SARS-CoV-2 from Western Europe around the second half of January 2020, much before any travel bans.
* The mutation D614G in the USA is mostly from Europe.
* Our model indicates that an unkown patient ZERO might have traveled from China to the USA anytime during the second half of December 2019.

## Europe
* Extensive genetic mixing across Europe.
* Since 27th March 2020, the virus spreads entirely within local communities (before there was a strong international origin).
* Our model indicates the first patients ZERO on the European continent likely came from the USA first during the second half of December 2019, quickly followed by another one from China early January 2020.


## Other areas of the world
* Most of new viral genomes from South America and Oceania are scattered across the SARS-CoV-2 phylogenetic tree. Without more contextual data, however, we aren't yet able to draw strong inferences about these new sequences.


(U) This computationnal project would not have been possible without the access to (and the dedicated support of) the Department of Defense <a href='https://www.hpc.mil' target='_blank'>High Performance Computing Modernization Program</a>. We are immensely grateful to the supercomputer DOD HPC team for their support in this "war" against SARS-CoV-2 virus: particularly, the <a href='https://www.navydsrc.hpc.mil/index.html' target='_blank'>Navy DoD Supercomputing Resource Center (Navy DSRC)</a> and the <a href='https://www.arl.hpc.mil/index.html' target='_blank'>Army Research Laboratory, Department of Defense Supercomputing Resource Center (ARL DSRC)</a>.
<br><br>
```

<!-- #############################################################################################################################  -->
<!-- #################################### BACKGROUND RESOURCES and FURTHER READING HERE n=2 ######################################  -->
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 2-->
# [Background Resources & Further Readings](https://localhost:8080/sars-cov-2/subsample)
(U) We prepared some reference materials to familiarize yourself with the notion of <b>Phylogeny, Phylogeography, and Phylodynamics</b> with applications to the origins of HIV-1 (AIDS), as well as other official readings about COVID-19 and the virus that causes it, SARS-CoV-2.
<br><br>
(U) This information suggested herewith will make the interpretation of phylogenetic data much easier to understand.

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown

## About Phylogeny, PhyloDynamics, and Phylogeography

[How to read a phylogenetic tree](https://evolution-outreach.biomedcentral.com/articles/10.1007/s12052-008-0035-x).

[Phylogeography article, PDF](https://www.cell.com/current-biology/pdf/S0960-9822(05)00503-8.pdf).

[Phylogeography on wikipedia](https://en.wikipedia.org/wiki/Phylogeography).

[Viral Phylodynamics](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1002947).

[Phylogeography of HIV-1](https://royalsocietypublishing.org/doi/full/10.1098/rstb.2010.0031).

[The early spread and epidemic ignition of HIV-1 in human populations](https://bedford.io/papers/faria-hiv-spread/).

[Evolutionary History and Phylogeography of Human Viruses](https://www.annualreviews.org/doi/full/10.1146/annurev.micro.62.081307.162912).


<br><br><br><br>
## Outside COVID-19 Ressources

[WHO Situation Reports](https://www.who.int/emergencies/diseases/novel-coronavirus-2019/situation-reports).

[CDC Resources](https://www.cdc.gov/coronavirus/2019-ncov/index.html).

[Coronavirus COVID-19 by Johns Hopkins University/CSSE](https://gisanddata.maps.arcgis.com/apps/opsdashboard/index.html#/bda7594740fd40299423467b48e9ecf6).

[Our World in Data](https://ourworldindata.org/coronavirus).

[Coronavirus Worldmeters](https://www.worldometers.info/coronavirus/).
```

<!-- ###################################################################################################  -->
<!-- #################################### ABOUT SAMPLING HERE n=3 ######################################  -->
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 3-->
# [A Note on Sampling](https://localhost:8080/sars-cov-2/subsample?c=country&r=country&d=map&p=grid&legend=closed)
(U) Currently, we have analyzed 31,695 RNA sequences from 6 continents.
<br><br>
(U) While these data enable to infer many useful characteristics of the outbreak and track its spread in real time, it is important to emphasize that our conclusions are limited by the available data.
<br><br>
(U) For example, the map shows relatively few sequences from the Southern Hemisphere. This is NOT because SARS-CoV-2 isn't circulating in these areas; rather, there is not much data available from these areas.
<br><br>
(U) The size of each circle on the map indicates how much data is currently available from that area, rather than the true size of the outbreak. One must keep in mind the the greater availability of data in a specific region (i.e., Europe) may create some biases in the interpretation of the trends for these overpresented areas.
<br><br>
(U) As of early September 2020, the breakdown per continent from the whole modeled dataset:
* <b>Africa</b>: 7.9%
* <b>Asia</b>: 26.6%
* <b>Europe</b>: 24.8%
* <b>North America</b>: 24.0%
* <b>Oceania</b>: 9.5%
* <b>South America</b>: 8.2%

<br><br>
(U) There is clearly a likely geographic under-representation of SARS-CoV-2 samples from the regions of Africa and South America.
<!-- There is NO right-side text -->



<!-- ###################################################################################################  -->
<!-- #################################### MUTATION STORY HERE n=4 ######################################  -->
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 4-->
# [SARS-CoV-2 is Slowly Mutating](https://localhost:8080/sars-cov-2/subsample?branchLabel=clade&c=region&l=clock&d=tree&legend=open)

(U) SARS-CoV-2 has 29,903 nucleotides of RNA and is mutating at a rate of about 1 to 1.7 mutations per month (~14 to 20 mutations per year) on average from December 2019 to present, globaly. The rate of mutation shows tiny variability over space:

<br><br>
* <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/north-america?branchLabel=clade&c=region&l=clock&d=tree&legend=open' target='_blank'>North America: Mutation rate estimate: 14.1 mutations/year</a>.
* <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/europe?branchLabel=clade&c=region&l=clock&d=tree&legend=open' target='_blank'>Europe: Mutation rate estimate: 18.8 mutations/year</a>.
* <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/asia?branchLabel=clade&c=region&l=clock&d=tree&legend=open' target='_blank'>Asia: Mutation rate estimate: 19.2 mutations/year</a>.
* <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/oceania?branchLabel=clade&c=region&l=clock&d=tree&legend=open' target='_blank'>Oceania: Mutation rate estimate: 19.2 mutations/year</a>.
* <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/africa?branchLabel=clade&c=region&l=clock&d=tree&legend=open' target='_blank'>Africa: Mutation rate estimate: 17.9 mutations/year</a>.
* <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/south-america?branchLabel=clade&c=region&l=clock&d=tree&legend=open' target='_blank'>South America: Mutation rate estimate: 18.8 mutations/year</a>.

<br><br>
(U) For comparison:
* <b>Seasonal Flu</b>: 49.42 mutations/year (14,000 nucleotides of RNA).
* <b>Ebola (ZEBOV)</b>: 19.84 mutations/year (~18,898 nucleotides of RNA).
* <b>Dengue</b>: 6.38 mutations/year (10,644 nucleotides of RNA).
* <b>Zika</b>: 9.26 mutations/year (10,794 nucleotides of RNA).
* <b>Tuberculosis</b>: 0.06 mutations/year (4,385,518 nucleotides; this is a bacterium).
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 5-->
# [A Mutation Worth Tracking?](https://localhost:8080/sars-cov-2/subsample?branchLabel=clade&c=gt-S_614&d=tree,map&l=radial&p=grid&r=location)

(U) Several scientific papers, not yet peer-reviewed, indicate the emergence of a new variation of SARS-CoV-2 which may be more contagious because of a mutation on Site 614. The original SARS-CoV-2 D-614 that codes for the Spike Protein of the Virus to attach with human cell via ACE2 receptor may have mutated into a newer version 614-G taking hold, first, in Europe and, then, spreading to New-York City … as shown later in this narrative, New York City SARS-CoV-2 came essentially from Europe.

<br><br>
(U) Here we show Site 614 across the world, both the orignal version D614 (blue), mostly present in Asia, and its newer form 614G (orange), mostly present in Europe and Eastern USA. This figure suggests that the newer form 614G is indeed the current dominant form in space and time.

<br><br>
(U) Here a listing of some of the papers discussing this specific mutation D614G and its implication in terms of potential transmissibility (some peer-reviewed, some in the process of being peer-reviewed):

* <a href='https://www.biorxiv.org/content/10.1101/2020.04.29.069054v2.full' target='_blank'>Spike mutation pipeline reveals the emergence of a more transmissible form of SARS-CoV-2</a>
* <a href='https://www.biorxiv.org/content/10.1101/2020.05.04.075911v1.full' target='_blank'>Global Spread of SARS-CoV-2 Subtype with Spike Protein Mutation D614G</a>
* <a href='https://www.biorxiv.org/content/10.1101/2020.04.24.059576v2.full' target='_blank'>Introductions and early spread of SARS-CoV-2 in France</a>
* <a href='https://www.authorea.com/users/314251/articles/444577-emergence-of-mutations-and-possible-antigenic-drift-in-the-surface-glycoprotein-of-sars-cov-2-covid-19?commit=6066a33a77d398dc70a36f670c43a2517a94e467' target='_blank'>Emergence of mutations and possible antigenic drift in the surface glycoprotein of SARS-CoV-2 (COVID-19)</a>
...
# [When D614G Mutation Happened?](https://localhost:8080/sars-cov-2/subsample?branchLabel=clade&c=gt-S_614&d=tree&dmax=2020-01-31&p=full&legend=open)

(U) The <a href='https://www.biorxiv.org/content/10.1101/2020.04.29.069054v2.full' target='_blank'>LANL study about the D614G Spike mutation</a> (which has not yet been peer-rewiewed) has been critized because the newer form 614G may have spread across Europe more by sheer luck rather than being more transmissible. Basically, 614G form of the virus easily spread within a population that has never exposed to this virus before (ie., "founder effect"; ie., the virus 614G mutation spread more by pure luck into a never exposed population).

<br><br>
(U) However, the LANL paper counter-explains: [<i>to differentiate between founder effects and a selective advantage driving the increasing frequency of the G clade, we applied the suite of tools that we had been developing for the SARS-CoV-2 analysis pipeline. A clear and consistent pattern was observed in almost every place where adequate sampling was available. In most countries and states where the COVID-19 epidemic was initiated and where sequences were sampled prior to March 1, the [original] D614 form was the dominant local form early in the epidemic. Wherever 614G entered a population, a rapid rise in its frequency followed, and in many cases 614G became the dominant local form in a matter of only a few weeks</i>]. Hence, LANL suggests that D614 came first but, then, was quickly out-competed by the new mutated form 614G.

<br><br>
(U) The figure on the right clearly shows indeed that the D614 form (in blue) solely existed since November 2019. Around 12 December 2019, according to our model, somewhere in China, the new form 614G mutated from D614 and then spread quickly outcompeting D614. The first 614G form was sampled in China on 01/24/2020 (sampled #: Zhejiang/HZ103/2020 from Zhejiang Provincial Center for Disease Control and Prevention and Sichuan/SC-PHCC1-022/2020 from West China Hospital of Sichuan University). Two days later, in Australia (sample Australia/NSW2153/2020 from New South Wales from a traveler from China) and, 4 days later, in Germany on 01/28/2020 (sampled #: Germany/BavPat1/2020).
...
# [D614G in(to) and from Europe](https://localhost:8080/sars-cov-2/subsample?branchLabel=clade&c=gt-S_614&d=tree,map&f_region=Europe)

(U) The figure shows the mutation D-to-G on site 614 (D, original, in blue and G, the new mutation, in orange). Europe receives the D614 form from Asia/China (blue). As the new mutated form, 614G, propagated into Europe, it spread to the rest of the world: Russia, USA, and South America. As a matter of fact, Europe serves as a middle ground for receiving this mutation and propagating to the world. Europe and the USA are the only places where the two forms, D614 and 614G, co-exist with a strong dominance for the newer mutated form.

<br><br>
(U) Please, zoom in/out or slide the map around to center it right.
<!-- There is no right side text -->

<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 8-->
# [D614G into the USA](https://localhost:8080/sars-cov-2/subsample?branchLabel=clade&c=gt-S_614&d=tree,map&f_country=USA&r=region)

(U) This figure shows the mutation D-to-G on site 614 (D, original, in blue and G, the new mutation, in orange).

<br><br>
(U)The USA receives the mutated from, 614G, mostly from Europe, Russia, and Israel, with the original form, D614, from Asia (<i>i.e.</i>, mostly China, South Korea, Japan, and Malaysia), Canada, Australia (which came from China), and to a smaller extent from Europe itself (<i>i.e.</i>, The Netherlands and, mostly, the UK, which received D614 from China).

<br><br>
(U) The current dominant form in the USA is the newer mutated form, 614G.
...
<!-- ####################################################################################################  -->
<!-- #################################### USA STORY LINE HERE  n=9 ######################################  -->
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 9-->
# [SARS-CoV-2 in North America](https://localhost:8080/sars-cov-2/subsample?d=tree,map&f_region=North%20America&legend=closed)
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 10-->
## [Extensive Mixing Across the U.S.](https://localhost:8080/sars-cov-2/subsample?d=tree,map&f_country=USA&legend=closed&r=region)

(U) The localized outbreaks within the US are the result of extensive mixing among different mutated strains of SARS-CoV-2 (all across the phylogenetic tree).
<br><br>
(U) While many of the early cases were travel-associated, the more recent cases from many different states are largely intermingled with each other across the tree (see next few slides). 
<br><br>
(U) Such intensive spread across the genetic tree of SARS-CoV-2 indicates (as we will show later) that the virus was systemically present in the USA much earlier than thought, as early as early-January 2020, likely even earlier.
<!-- This is no right-side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 11-->
## [The USA Got Hit by the Virus from Around the World](https://localhost:8080/sars-cov-2/subsample?d=map&f_country=USA&r=region)

(U) From January to early March 2020, the USA clearly got hit by different variation of the virus from across the world, most notably from Europe, UK, Canada, China, and Australia.

<br><br>
(U) Please, slide the map and/or zoom out to place the USA in a world perspective ...
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 12-->
## [The First Carrier in the USA?](https://localhost:8080/sars-cov-2/subsample?d=map,tree&dmax=2019-12-21)

(U) We will never know for certain who is the very first individual who brought SARS-CoV-2 to the USA and when that happened.

<br><br>
(U) Our model, which infers the phylogenic timing of SARS-CoV-2, seems to indicate that this hypothetical (i.e., modeled) patient ZERO might have been in the USA during the first half of December 2019 traveling from China. This result, if confirmed (and this is only a model), would make the USA one of the first country in the world hit by SARS-CoV-2 from China. This has been somehow confirmed by others: <a href='https://www.bbc.com/news/world-us-canada-52385558' target='_blank'>Coronavirus: First US deaths weeks earlier than thought</a>.

<br><br>
(U) The implication is that the virus may have been lurking, undetected, in the USA, for much longer than anyone may have realized. While undetected, it would have given plenty of time for this virus to solidly take hold within our communities making any counter-measures against this national epidemy much too late to be as effective as one would have anticipated. The second implication is that the virus has been within our communities for a solid 9 months; it is likely this virus is now systemic in our communities.

<br><br>
(U) Please, zoom in/out or slide the map around to center it right. This result can only be correctly displayed with the <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/all?d=map,tree&dmax=2019-12-02' target='_blank'>the "all" dataset</a> (be patient: it may take an impossibly long time to load this).
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 13-->
## [Before March 2020](https://localhost:8080/sars-cov-2/subsample?c=country_exposure&d=tree&dmax=2020-03-01&f_country=USA&l=radial&p=grid&legend=closed)

(U) Before March 2020, there is strong indication of an OCONUS origin of the virus (all colors but blue-violet), then followed by an out-of-control community spread: as shown by the mauve dots, most of the cases in the USA in January-March 2020 had already a purely local origin, much before the travel ban (see New-York paragraph).
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 14-->
## [By early-March 2020, the Spread is Uniquely Local](https://localhost:8080/sars-cov-2/subsample?c=country_exposure&d=tree&dmin=2020-03-01&f_country=USA&l=radial&legend=closed&p=grid)

(U) As indicated by all blue-violet dots, the virus spread is now purely local. The phylogenetic tree clearly shows no origin from the world after March 2020.
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 15-->
## [Origin of SARS-CoV-2 in New-York](https://localhost:8080/sars-cov-2/subsample?branchLabel=clade&c=legacy_clade_membership&d=tree,map&f_division=New%20York&p=grid&r=division)

(U) New-York city has been hit the hardest by SARS-CoV-2, it would be interesting to understand why. How early did the virus came in the city? How soon did it start to community spread around undetected? Are there any lessons one can learn for the next pandemic?

<br><br>
(U) <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/north-america?branchLabel=clade&c=legacy_clade_membership&d=tree,map&f_division=New%20York&p=grid' target='_blank'>We show all known samples from New York State (mostly from New York city)</a>. Like all the other cases in the USA, there is a large variability in the genomic tree of SARS-CoV-2 genome from New York, spread among the many clades of its genomic trees, such as:

* <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/north-america?branchLabel=clade&c=legacy_clade_membership&d=tree&f_division=New%20York&label=clade:20C&p=full' target='_blank'>A2</a>.
* A1a
* <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/north-america?branchLabel=clade&c=legacy_clade_membership&d=tree&f_division=New%20York&label=clade:19B&p=full' target='_blank'>B and B1</a>.
* There are a few more samples from other clades as well: A3, A6, B, B4, etc.

<br><br>
(U) The map also shows--by genetic clade colors--the exact origin of the SARS-CoV-2 virus in New-York. It indicates that most of the cases have a European origin. As a matter of fact, only a few 10s of known sampled cases in New York City are from China (A1a, A3, B1), Israel, and Australia; all other known SARS-CoV-2 are directly from Europe. The clade A2, dominant in New York, is <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/all?branchLabel=clade&c=legacy_clade_membership&d=tree,map&f_division=New%20York&p=grid&r=location' target='_blank'>entirely from Europe</a>.

(U) To visualize this better within a complete perspective, you can load the same map with the <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/all?branchLabel=clade&c=legacy_clade_membership&d=tree,map&f_division=New%20York&p=grid' target='_blank'>complete "all" dataset</a> (however it may take a while to load up this enormous dataset).

<br><br>
(U) When did SARS-CoV-2 arrive in New-York?
<!-- There is no right side text -->

<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 16-->
## [When Patient ZERO arrived in New York city?](https://localhost:8080/sars-cov-2/subsample?branchLabel=clade&c=legacy_clade_membership&d=tree&f_division=New%20York&p=full)

(U) A detailed analysis of the Greatest Common ancestral tree node allow us to retrieve plausibe dates of entry of SARS-CoV-2 in the area of New-York:


* <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/all?branchLabel=clade&c=legacy_clade_membership&d=tree,map&f_division=New%20York&label=clade:20C&p=full' target='_blank'>Around mid-January 2020 for clade A2 (mostly from Europe, Australia, New Zealand)</a>.
* From end of December 2019 and first half of January 2020 for clade A1a (from Europe and China).
* <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/all?branchLabel=clade&c=legacy_clade_membership&d=tree,map&f_division=New%20York&label=clade:19B&p=full' target='_blank'>Within the month of January 2020 for clade Bs (from China, Australia, and Europe)</a>.



(U) Hence, SARS-CoV-2 virus started to circulate around New-York undetected as early as the first half of January 2020; most came from Western Europe. As a recap, presidential travel bans <a href='https://www.cato.org/blog/timeline-list-us-immigration-actions-covid-19' target='_blank'>were proclaimed much after</a> :
<br><br>
* On 01/31/2020, China ban—Presidential <a href='https://www.whitehouse.gov/presidential-actions/proclamation-suspension-entry-immigrants-nonimmigrants-persons-pose-risk-transmitting-2019-novel-coronavirus/' target='_blank'>Proclamation 9984</a>.
<br><br>
* On 03/11/20, Europe ban—Presidential <a href='https://www.federalregister.gov/documents/2020/03/16/2020-05578/suspension-of-entry-as-immigrants-and-nonimmigrants-of-certain-additional-persons-who-pose-a-risk-of' target='_blank'>Proclamation 9993</a>.
<!-- There is no right side text -->


<!-- #######################################################################################################  -->
<!-- #################################### EUROPE STORY LINE HERE n=17 ######################################  -->
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 17-->
# [SARS-CoV-2 in Europe](https://localhost:8080/sars-cov-2/subsample?d=tree,map&f_region=Europe&legend=closed)
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 18-->
## [Extensive Mixing Across Europe.](https://localhost:8080/sars-cov-2/subsample?branchLabel=clade&c=country&d=tree,map&f_region=Europe&legend=closed&p=grid&r=location)

(U) These European outbreaks are the result of extensive mixing across the continent.
<br><br>
(U) While many of the early cases were travel-associated, the more recent cases from many different states are largely intermingled with each other across the tree.
<br><br>
(U) Note the lack of data from Italy; the map for Italy might be more complex.
<br><br>
(U) Please, zoom in/out or slide the map around to center it right on the European continent.
<!-- This is no right-side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 19-->
## [Before 27 March 2020](https://localhost:8080/sars-cov-2/subsample?c=region_exposure&d=tree&dmax=2020-03-27&dmin=2019-11-10&f_region=Europe&l=radial&p=grid)

(U) Before 27 March 2020, there is a strong international origin of the virus in Europe.
<br><br>
(U) However, as also shown by the gray dots in February-March 2020, the virus swiftly spreads across Europe by community spread (<i>i.e.</i>, local origin).
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 20-->
## [After 27 March 2020, the Spread is from within](https://localhost:8080/sars-cov-2/subsample?c=region_exposure&d=tree&dmin=2020-03-28&f_region=Europe&l=radial&legend=closed&p=grid)


(U) After 28 March 2020, as indicated by all gray dots, all new outbreaks have now a purely local origin (with an exception for a few cases from Northern Africa).
<!-- There is no right side text -->


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 21-->
## [The First Carrier in Europe?](https://localhost:8080/sars-cov-2/subsample?branchLabel=clade&c=region_exposure&d=map,tree&dmax=2020-03-08&r=region)

(U) We will never know for certain who is the very first individual who brought SARS-CoV-2 to the European continent and when that exactly happened.

<br><br>
(U) Our model, which infers the phylogenic clock of SARS-CoV-2, seems to indicate that the hypothetical (i.e., modeled) patient ZERO might have carried the virus to the European continent from the <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/all?branchLabel=clade&c=region_exposure&d=map,tree&dmax=2019-12-31&f_region=Europe' target='_blank'>USA first (second half of December 2019)</a> and, then, from <a href='https://sars-cov-2.dev.east.paas.nga.mil/sars-cov-2/all?branchLabel=clade&c=region_exposure&d=map,tree&dmax=2020-01-15&f_region=Europe' target='_blank'>from China (first half of January 2020)</a>.

<br><br>
(U) As for the USA, SARS-CoV-2 may have been within the European communities much earlier than anticipated, which is now well reported:

* <a href='https://www.bbc.com/news/health-52935644' target='_blank'>Was coronavirus here earlier than we thought?</a>.
* <a href='https://www.bbc.com/news/world-europe-52526554' target='_blank'>Coronavirus: France's first known case was in December</a>.
<!-- There is no right side text -->



<!-- ###########################################################################################################  -->
<!-- #################################### CONCLUSION STORY LINE HERE n=22 ######################################  -->
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 22-->
# [Conclusions](https://localhost:8080/sars-cov-2/subsample?c=clade_membership&d=map&p=full&r=region)
## (U) Phylodynamics ...
#### ... Strength of this method
* Allow to model possible patient ZERO origin and/or the exact origin in time and space of the virus.
* Allow to monitor the number of mutations and the mutation rate in space and time to identify possible emergence of new viral forms.
* Allow to identify early-on the emergence of a <i>Second Wave</i>, its phylogenic nature, in space and time.

#### ... Weackenesses  
* Its strength is in the availability of the data: the more, the merrier; its weackness is its lack of data or unbalanced data availability in space and/or time.
* A data "imbalance" in any geographic location could create an over-representation of local trends from well sampled regions (<i>i.e.</i>, Europe, USA).
...
# (U) Main Take Aways
 ...
 - The US and Europe show a large spread of cases across the whole phylogenetic tree demonstrating multiple origins, across borders, state lines, and within communities.
 
 - The data suggest that, since mid-March 2020, all new cases in the USA are from within.
 
 - SARS-CoV-2 mutation rates is about 14 to 20 per year globally. However this mutation rate shows variability in space and time; the SARS-CoV-2 mutation rate is twice less than the Seasonal Flu rate (~49 mutations/year).
 
 - Cases across the U.S. co-mingle on the tree, demonstrating extensive spread across state lines.

 - There are strong evidences to suggest that SARS-CoV-2 started to massively spread--undetected--in New-York City within the second half of January 2020, much before any travel bans.The origin of the virus in New York city is overwhelmingly European.

 - As others have published, the mutation 614G is predominently the dominant form in the world, particularly in Europe and the USA.

 - Our model suggest that the first patients ZERO arrive in the USA and Europe sometimes between December 2019 and early January 2020. This demonstrates that the virus may have spread undetected within many communities for many weeks from December 2019 ... The virus is endemic within our societies. 
 
```

<!-- ########################################################################################################  -->
<!-- #################################### CREDIT STORY LINE HERE n=23  ######################################  -->
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 23-->
# [Scientific Credits](https://localhost:8080/sars-cov-2/all?c=country&d=map&p=full)

(U) We would like to acknowledge the work done by all scientists involved in sequencing SARS-CoV-2 samples and sharing their samples with the scientific community.

<br><br>
(U) We also gratefully acknowledge [GISAID](https://gisaid.org) and [NextStrain](https://nextstrain.org) for providing the platform through which these data can be uploaded, shared, modeled, and visualized.

<br><br>
(U) We thank the US Department of Defense High Performance Computing Modernisation Program [HPC.mil](https://gisaid.org) for granting access to their supercomputers to bio-informatically process many tens of thousands SARS-CoV-2 samples.


<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
(U) We are grateful for the data gathered by these originating labs:
...
<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 24 -->
# [Detailed Scientific Credits](https://localhost:8080/sars-cov-2/all?d=map&c=author)

(U) These data were shared via [GISAID](https://gisaid.org).
(U) We gratefully acknowledge [GISAID](https://gisaid.org) and [NextStrain](https://nextstrain.org) for their contributions.

<br>

(U) To the right we give specific sequences shared by each lab.


<!-- This is right-side text -->
```auspiceMainDisplayMarkdown

(U) The SARS-CoV-2 genomes were generously shared by scientists at these submitting labs:
